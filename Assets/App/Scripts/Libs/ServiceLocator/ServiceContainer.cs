...
namespace App.Scripts.Libs.ServiceLocator
{
    ...
    {
        private readonly Dictionary<Type, IServiceContainer> _containers = new Dictionary<Type, IServiceContainer>();
        ...
        {
            private readonly List<TBind> _values = new List<TBind>();
